	...
	//theme settings
		if (is_array($_SESSION['theme']) && @sizeof($_SESSION['theme']) != 0) {
			...
			//pre-process some settings
				...
				$settings['theme']['footer'] = $settings['theme']['footer'] != '' ? $settings['theme']['footer'] : '&copy; '.$text['theme-label-copyright'].' 2008 - '.date('Y')." <a href='http://www.othos.co.za' class='footer' target='_blank'>Othos Telecom</a> ".$text['theme-label-all_rights_reserved']."<br><a href='http://www.othos.co.za/bundles/othossite/pdf/othos_terms_and_conditions.pdf' class='footer' target='_blank'>By making your first call, enrolling in, activating, using, or paying for the services, you agree to the terms and conditions in this agreement</a>";
